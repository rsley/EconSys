...
module.exports = {
  ...
  callback: async ({
    ...
    if (targetP.education.educationLevel === 2)
      education = `Associate's Degree (${targetP.education.universityAttended})`;
    if (targetP.education.educationLevel === 3)
      education = `Bachelor's Degree (${targetP.education.universityAttended})`;
    if (targetP.education.educationLevel === 4)
      education = `Master's Degree (${targetP.education.universityAttended})`;
    if (targetP.education.educationLevel === 5)
      education = `Ph.D. (${targetP.education.universityAttended})`;
    ...
    if (targetP.achievements.awardsAndRecognitions) {
      awardsAndRecognitions =
        targetP.achievements.awardsAndRecognitions.length > 0
          ? targetP.achievements.awardsAndRecognitions.join(", ")
          : "None";
    } else {
    ...
    const balDesc = `**Net worth:** ${numbers(
